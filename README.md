---
website: "Provedoria de Justiça"          # Entre as aspas escreve o nome do website
date: "08/06/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://www.provedor-jus.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://www.provedor-jus.pt/acessibilidade/" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Provedoria de Justiça"         # Entre as aspas escrever o nome do owner do website
...
<details>
  ...
  <ul aria-label="lista de relatórios já efetuados">
    <li><a href="08062026_report.html">(08/06/2026). Relatório {{ page.website }}</a></li>
  </ul>
</details>
